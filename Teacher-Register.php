...
<body>
    ...
    <div class="fade-container">
        ...
        <div class="right-section">
            ...
            <form id="registration-form" action="teacher-register-process.php" method="POST" autocomplete="on">
    ...
    // Check field validation for teacher
    if (roleCheck.toLowerCase() !== "wills") {
        e.preventDefault();
