    ...
    <div class="fade-container">
     <div class="container">
        ...
        <div class="right-section">
            ...
            <form id="registration-form" action="parent-register-process.php" method="POST">
...
document.getElementById('registration-form').addEventListener('submit', function(e) {
    ...
    if(!fullname){
        e.preventDefault();
        errorMsg.textContent = "Please fill the Full Name field!";
        return;
    }
    ...
    if(!contact){
        e.preventDefault();
        errorMsg.textContent = "Please fill the Contact field!";
        return;
    }
    if(!password){
        e.preventDefault();
        errorMsg.textContent = "Please fill the Password field!";
        return;
    }
    ...
    if(!email){
        e.preventDefault();
        errorMsg.textContent = "Please fill the Email field!";
        return;
    }
